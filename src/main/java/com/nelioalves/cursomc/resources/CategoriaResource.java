...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO categoriaDTO) {
		Categoria categoria = service.insert(categoriaDTO.toEntity());
	...
	public ResponseEntity<Void> update(@PathVariable Integer id, @Valid @RequestBody CategoriaDTO categoriaDTO) {
		...
		Categoria categoria = service.update(categoriaDTO.toEntity());
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		List<CategoriaDTO> categoriasDTO = service.findAll().stream().map(CategoriaDTO::new).collect(Collectors.toList());
